...
export default function App() {
  ...
  const checkSession = async () => {
    ...
    try {
      ...
      console.error('Stale auth session, resetting locks...');
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Auth failure - Server response details:', serverErrorMessage);
      console.error('Full authorization error context:', err);
